 ...
 * @param {Number} [waitBetweenQueries=30] - Number of seconds to wait between
 *   calls to consume records.
 * @param {(String|Array<String>)} [topics] - Topic or array of topics. If set
 *   to a non-empty value, the channel will be subscribed to the specified
 *   topics. If set to an empty value, the channel will use topics previously
 *   subscribed via a call to the {@link Channel#subscribe} method.
